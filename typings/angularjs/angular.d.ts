...
declare module angular {
    ...
    interface IAngularStatic {
        ...
        /**
         * Deeply extends the destination object dst by copying own enumerable properties from the app object(s) to dst. You can specify multiple app objects. If you want to preserve original objects, you can do so by passing an empty object as the target: var object = angular.merge({}, object1, object2).
         *
