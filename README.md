...
###### gulp serve-no-ts
Ignores TypeScript files so if you prefer to let the IDE compile TS use this command. Gulp will copy the js files generated by your IDE to the dist folder.
